  ...
  {//1
    ...
    {//2
      ...
      if (ledState == LOW) 
      {
        ...
        pwm2.setPWM(5, 0, 4096); // temporary driver for triple 2
      ...
      else 
      {
        ...
        pwm2.setPWM(5, 4096, 0); // temporary driver for triple 2
  ...
  if (soundbutton != 0) 
  {
    if (currentMillis - previousMillis9 >= ledinterval2) 
    {
      ...
      if (ledState2 == LOW) 
      {
        ...
        pwm2.setPWM(6, 0, 4096); // temporary driver for triple 3
      }
      else 
      {
        ledState2 = LOW;
        ...
        pwm2.setPWM(6, 4096, 0); // temporary driver for triple 3
      }
...
void holoServo2() {
  ...
  if (currentMillis - previousMillis2 >= randomtime2) {
    ...
    pos2 = random(150, 600);
    pwm2.setPWM(13, 0, pos2);
  }
  // else {
  //  pwm2.setPWM(13, 0, holoCentreVal);
  // }
}
...
void holoServo3() {
  ...
  if (currentMillis - previousMillis3 >= randomtime3) {
    ...
    pos3 = random(150, 600);
    pwm2.setPWM(15, 0, pos3);
  }
 // else {
 //   pwm2.setPWM(15, 0, holoCentreVal);
 // }
}
...
void updatePeriscopePosition(){
  ...
  pwm2.setPWM(9, 0, periscopeposition);
}
...
void servoSetup2() {
  pwm2.setPWM( 0, 4096, 0); // *Dome lights 1
  pwm2.setPWM( 1, 4096, 0); // *Dome lights 2
  pwm2.setPWM( 2, 4096, 0); // *Dome lights 3
  pwm2.setPWM( 3, 4096, 0); // *Dome lights 4
  pwm2.setPWM( 4, 4096, 0); // *Dome lights 5 Triple 1
  pwm2.setPWM( 5, 4096, 0); // *Dome lights 6 Triple 2 Temporarily Inverse of Dome Light 1 
  pwm2.setPWM( 6, 4096, 0); // *Dome lights 7 Triple 3 Temporarily Inverse of Dome Light 3
  pwm2.setPWM( 7, 0,    0); // Not Connected
  pwm2.setPWM( 8, 4096, 0);             // *Periscope Light
  pwm2.setPWM( 9, 0,    peridown);      // *Periscope Servo
  pwm2.setPWM(10, 4096, 0);             // *Holo Light 1
  pwm2.setPWM(11, 0,    holoCentreVal); // *Holo Servo 1
  pwm2.setPWM(12, 4096, 0);             // *Holo Light 2
  pwm2.setPWM(13, 0,    holoCentreVal); // *Holo Servo 2
  pwm2.setPWM(14, 4096, 0);             // *Holo Light 3
  pwm2.setPWM(15, 0,    holoCentreVal); // *Holo Servo 3
}
